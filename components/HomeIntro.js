      ...
      <div className="text-blue-100 my-auto">
        <div className="mx-auto text-center text-shadow-md">
          ...
          <ul className="text-xl md:text-3xl italic mb-10">
            <li className="text-blue-300 mb-1">- Single page apps with <strong>Next.js</strong></li>
            <li className="text-purple-300 mb-1">- Games and XR with <strong>Unity 3D</strong></li>
