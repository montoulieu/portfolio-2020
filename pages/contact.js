        ...
        <div className="relative ">
          ...
          >
            <rect
              ...
              height="97.5095"
              rx="37.5"
              transform="rotate(-75 21.7649 271.325)"
              fill="#34d399"
              stroke="black"
              strokeWidth="6"
            />
            <path
              d="M97.6225 233C88.3774 245.471 84.3469 254.404 86.6225 275"
              stroke="black"
              strokeWidth="3"
            />
            <rect
              ...
              height="114.966"
              rx="37.5"
              transform="rotate(-75 14.9037 171.807)"
              fill="#f87171"
              stroke="black"
              strokeWidth="6"
            />
            <path
              d="M113.622 138C104.377 150.471 100.347 159.404 102.622 180"
              stroke="black"
              strokeWidth="3"
            />
            <rect
              ...
              height="115.414"
              rx="37.5"
              transform="rotate(-75 4.47065 76.6911)"
              fill="#a78bfa"
              stroke="black"
              strokeWidth="6"
            />
            <path
              d="M103.802 41.9999C94.5566 54.4707 90.5261 63.4044 92.8017 83.9999"
              stroke="black"
              strokeWidth="3"
            />
          </svg>
          ...
          <svg
            ...
            width="1338"
            height="1302"
            viewBox="0 0 1338 1302"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              d="M281.451 593.309L279.363 595.262L281.213 597.442L1034.21 1484.44L1035.35 1485.78L1037.08 1485.44L1443.58 1405.94L1448.98 1404.89L1445.16 1400.92L487.162 404.92L485.111 402.788L482.951 404.809L281.451 593.309Z"
              fill="#34d399"
              stroke="black"
              strokeWidth="6"
            />
            <rect
              ...
              height="349.59"
              rx="113"
              transform="rotate(-133.658 279.454 648.859)"
              fill="#e879f9"
              stroke="black"
              strokeWidth="6"
            />
            ...
            >
              ...
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M420.117 85.0736C403.972 94.1457 398.239 114.588 407.311 130.732L444.725 197.313C443.824 199.5 443.107 201.798 442.596 204.194L415.817 329.89C411.26 351.28 424.906 372.315 446.296 376.872C467.686 381.429 488.721 367.783 493.278 346.393L520.057 220.697C520.984 216.348 521.158 212.013 520.667 207.828C521.308 201.238 520.009 194.393 516.52 188.183L465.775 97.8792C456.703 81.7349 436.261 76.0016 420.117 85.0736Z"
              />
            </mask>
            <path
              fillRule="evenodd"
            ...
            <rect
              ...
              height="136.944"
              rx="37.5"
              transform="rotate(-75 3.67423 76.1187)"
              fill="#60a5fa"
              stroke="black"
              strokeWidth="6"
            />
          </svg>
          <div className="block warp-drive">
            <div className="warp-wrap">
              <div className="warp-side warp-right" />
              <div className="warp-side warp-left" />
              <div className="warp-side warp-top" />
              <div className="warp-side warp-bottom" />
              <div className="warp-side warp-back" />
            </div>
            <div className="warp-wrap">
              <div className="warp-side warp-right" />
              <div className="warp-side warp-left" />
